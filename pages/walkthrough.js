...
// âœ… FIELD-FIRST WALKTHROUGH.JS (SAFE VERSION)
...
export default function Walkthrough() {
  ...
  const handleChange = (index, section, field, value) => {
    ...
    if (!section) {
      ...
      updated[index][section] = { ...updated[index][section], [field]: value };
    }
    setRooms(updated);
  };
  ...
  const handleNested = (index, section, group, field, value) => {
    ...
    if (!updated[index][section][group]) updated[index][section][group] = {};
